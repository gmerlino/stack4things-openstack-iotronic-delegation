...
@cliutils.arg('plugin', metavar='<plugin>',
              help="Name or UUID of the plugin.")
def do_plugin_delegations(cc, args):
    """List plugin delegations."""

    fields = res_fields.DELEGATION_RESOURCE.fields
    delegations = cc.delegation.list(args.plugin, 'plugin')
...
def do_plugin_delegate(cc, args):
    """Register a delegation for a plugin resource."""
    ...
    delegation = cc.delegation.create(args.plugin, **fields)
