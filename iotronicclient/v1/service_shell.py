...
@cliutils.arg('service', metavar='<service>',
              help="Name or UUID of the service.")
def do_service_delegations(cc, args):
    """List service delegations."""

    fields = res_fields.DELEGATION_RESOURCE.fields
    delegations = cc.delegation.list(args.service, 'service')
...
def do_service_delegate(cc, args):
    """Register a delegation for a service resource."""
    ...
    delegation = cc.delegation.create(args.service, **fields)
