...
from iotronicclient.v1 import user
from iotronicclient.v1 import role
from iotronicclient.v1 import board
from iotronicclient.v1 import delegation
...
class Client(object):
    ...
    def __init__(self, endpoint=None, *args, **kwargs):
        ...
        self.user = user.UserManager(self.http_client)
        self.role = role.RoleManager(self.http_client)
        self.delegation = delegation.DelegationManager(self.http_client)
