...
@cliutils.arg('fleet', metavar='<fleet>',
              help="Name or UUID of the fleet.")
def do_fleet_delegations(cc, args):
    """List fleet delegations."""

    fields = res_fields.DELEGATION_RESOURCE.fields
    delegations = cc.delegation.list(args.fleet, 'fleet')
...
def do_fleet_delegate(cc, args):
    """Register a delegation for a fleet resource."""
    ...
    delegation = cc.delegation.create(args.fleet, **fields)
