...
@cliutils.arg('board', metavar='<board>',
              help="Name or UUID of the board.")
def do_board_delegations(cc, args):
    """List board delegations."""

    fields = res_fields.DELEGATION_RESOURCE.fields
    delegations = cc.delegation.list(args.board, 'board')
...
def do_board_delegate(cc, args):
    """Register a delegation for a board resource."""
    ...
    delegation = cc.delegation.create(args.board, **fields)
