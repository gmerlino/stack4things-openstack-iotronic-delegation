...
class UpdatePluginDelegationForm(forms.SelfHandlingForm):
    plugin = forms.CharField(label=_("Plugin ID"), widget=forms.HiddenInput)
    ...
    def __init__(self, *args, **kwargs):
        super(UpdatePluginDelegationForm, self).__init__(*args, **kwargs)
...
class DeletePluginDelegationForm(forms.SelfHandlingForm):
    plugin = forms.CharField(label=_("Plugin ID"))
    delegation = forms.CharField(label=_("Delegation ID"))

    def __init__(self, *args, **kwargs):
        super(DeletePluginDelegationForm, self).__init__(*args, **kwargs)
        self.fields["plugin"].widget.attrs = {'readonly': 'readonly'}
...
class PluginDelegateForm(forms.SelfHandlingForm):

    plugin_uuid = forms.CharField(label=_("Plugin ID"))
    ...
    def __init__(self, *args, **kwargs):
        super(PluginDelegateForm, self).__init__(*args, **kwargs)
        ...
        self.fields["plugin_uuid"].widget.attrs = {'readonly': 'readonly'}

    def handle(self, request, data):
        try:
            iotronic.node_create_delegation(request, data['plugin_uuid'],
                                            {'delegated': data['user'],
                                             'role': data['role'],
                                             'type': 'plugin'})
