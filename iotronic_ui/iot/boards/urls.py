...
urlpatterns = [
    ...
    url(r'^(?P<board_id>[^/]+)/detail/$', views.BoardDetailView.as_view(),
        name='detail'),
    url(r'^(?P<board_id>[^/]+)/delegate/$', views.BoardDelegateView.as_view(),
        name='delegateboard'),
    url(r'^(?P<board_id>[^/]+)/delegations/$',
        views.BoardDelegationsView.as_view(),
        name='delegations'),
    url(r'^boards/delegations/(?P<delegation_id>[^/]+)/update/$',
        views.DelegationUpdateView.as_view(),
        name='delegationupdate'),
    url(r'^boards/delegations/(?P<delegation_id>[^/]+)/delete/$',
