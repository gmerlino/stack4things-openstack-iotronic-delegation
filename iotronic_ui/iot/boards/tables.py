...
class DelegateLink(tables.LinkAction):
    name = "delegateboard"
    verbose_name = _("Delegate Board")
    url = "horizon:iot:boards:delegateboard"
    classes = ("ajax-modal",)
    icon = "plus"
...
class BoardsTable(tables.DataTable):
    ...
    delegations = tables.WrappingColumn('delegations',
                                        link="horizon:iot:boards:delegations",
                                        verbose_name=_(''))
    ...
    class Meta(object):
        ...
        row_actions = (EditBoardLink, DelegateLink, EnableServiceLink,
                       DisableServiceLink, RestoreServices, AttachPortLink,
                       DetachPortLink, EnableWebServiceLink,
                       DisableWebServiceLink, RemovePluginsLink,
                       DeleteBoardsAction)
...
class EditDelegationLink(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:iot:boards:delegationupdate"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class DeleteDelegationsAction(tables.LinkAction):
    ...
    url = "horizon:iot:boards:delegationdelete"
    classes = ("ajax-modal",)
    icon = "trash"
    action_type = "danger"
...
class DelegationsTable(tables.DataTable):
    ...
    node = tables.Column('node', verbose_name=_('Board'))
