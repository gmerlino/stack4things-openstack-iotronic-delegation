...
class UpdateBoardDelegationForm(forms.SelfHandlingForm):
    board = forms.CharField(label=_("Board ID"), widget=forms.HiddenInput)
    ...
    def __init__(self, *args, **kwargs):
        super(UpdateBoardDelegationForm, self).__init__(*args, **kwargs)
...
class DeleteBoardDelegationForm(forms.SelfHandlingForm):
    board = forms.CharField(label=_("Board ID"))
    delegation = forms.CharField(label=_("Delegation ID"))

    def __init__(self, *args, **kwargs):
        super(DeleteBoardDelegationForm, self).__init__(*args, **kwargs)
        self.fields["board"].widget.attrs = {'readonly': 'readonly'}
...
class BoardDelegateForm(forms.SelfHandlingForm):

    board_uuid = forms.CharField(label=_("Board ID"))
    ...
    def __init__(self, *args, **kwargs):
        super(BoardDelegateForm, self).__init__(*args, **kwargs)
        ...
        self.fields["board_uuid"].widget.attrs = {'readonly': 'readonly'}

    def handle(self, request, data):
        try:
            iotronic.node_create_delegation(request, data['board_uuid'],
                                            {'delegated': data['user'],
                                             'role': data['role'],
                                             'type': 'board'})
