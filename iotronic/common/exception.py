...
class UserNotFound(NotFound):
    message = _("User %(user)s could not be found.")


class RoleNotFound(NotFound):
    message = _("Role %(role)s could not be found.")
...
class RoleAlreadyExists(Conflict):
    message = _("A Role with name %(name)s already exists.")


class DelegationEscalationRoleConflict(Conflict):
    message = _("Unable to assign a role with greater privileges.")


class DelegationAlreadyExists(Conflict):
    message = _("A Delegation already exists.")


class DelegationNotFound(NotFound):
    message = _(
        "No Delegation found or User not authorized to use this resource.")
