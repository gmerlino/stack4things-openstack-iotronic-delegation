...
#    public = PublicPortsController()
    ...
    def _get_ports_collection(self, authorized_ports, marker, limit, sort_key,
                              sort_dir, fields=None, with_public=False,
                              all_ports=False):
...
#                    filters['with_public'] = with_public
        ...
        ports = objects.Port.list(pecan.request.context, authorized_ports,
    ...
    def get_all(self, marker=None,
        ...
        """
        authorized_ports = authorization.authorize('port:get')

        if fields is None:
            fields = _DEFAULT_RETURN_FIELDS
        return self._get_ports_collection(authorized_ports, marker,
...
#            authorization.authorize('port:get_one',rpc_port.uuid)
