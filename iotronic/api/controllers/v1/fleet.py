...
class FleetBoardsController(rest.RestController):
    ...
    def get_all(self, marker=None,
        ...
        boards = objects.Board.list(pecan.request.context,
                                    authorized_boards, limit, marker,
...
class FleetsController(rest.RestController):
    ...
    def _get_fleets_collection(self, authorized_fleets, marker, limit,
                               sort_key, sort_dir,
                               fields=None):
        ...
        filters = {}
        fleets = objects.Fleet.list(pecan.request.context, authorized_fleets,
    ...
    def get_one(self, fleet_ident, fields=None):
        ...
        authorization.authorize('fleet:get_one', rpc_fleet.uuid)
    ...
    def get_all(self, marker=None,
        ...
        :param fields: Optional, a list with a specified set of fields
                       of the resource to be returned.
        """
        authorized_fleets = authorization.authorize('fleet:get')

        if fields is None:
            fields = _DEFAULT_RETURN_FIELDS
        return self._get_fleets_collection(authorized_fleets, marker,
    ...
    def post(self, Fleet):
        ...
        """
        authorization.authorize('fleet:create')
        ...
        new_Fleet.project = pecan.request.context.project_id
        ...
        new_Delegation.node = new_Fleet.uuid
        new_Delegation.type = 'fleet'
    ...
    def delete(self, fleet_ident):
        ...
        rpc_fleet = api_utils.get_rpc_fleet(fleet_ident)
        authorization.authorize('fleet:delete', rpc_fleet.uuid)

        pecan.request.rpcapi.destroy_fleet(pecan.request.context,
                                           rpc_fleet.uuid)

        # remove all fleet delegations
        objects.Delegation.destroy_by_node_uuid(
            pecan.request.context, rpc_fleet.uuid, 'fleet')
    ...
    def patch(self, fleet_ident, val_Fleet):
        ...
        rpc_fleet = api_utils.get_rpc_fleet(fleet_ident)
        authorization.authorize('fleet:update', rpc_fleet.uuid)
