...
class PublicServicesController(rest.RestController):
    ...
    def _get_services_collection(self, authorized_services, marker, limit,
                                 sort_key, sort_dir,
                                 fields=None):
    ...
    def get_all(self, marker=None,
        ...
        """
        authorized_services = authorization.authorize('service:get')

        if fields is None:
            fields = _DEFAULT_RETURN_FIELDS
        return self._get_services_collection(authorized_services, marker,
...
class ServicesController(rest.RestController):
    ...
    def get_one(self, service_ident, fields=None):
        ...
        authorization.authorize('service:get_one', rpc_service.uuid)
    ...
    def post(self, Service):
        ...
        """
        authorization.authorize('service:create')
        ...
        new_Service.project = pecan.request.context.project_id
        ...
        new_Delegation.node = new_Service.uuid
        new_Delegation.type = 'service'
    ...
    def delete(self, service_ident):
        ...
        rpc_service = api_utils.get_rpc_service(service_ident)
        authorization.authorize('service:delete', rpc_service.uuid)
        pecan.request.rpcapi.destroy_service(pecan.request.context,
                                             rpc_service.uuid)

        # remove all service delegations
        objects.Delegation.destroy_by_node_uuid(
            pecan.request.context, rpc_service.uuid, 'service')
    ...
    def patch(self, service_ident, val_Service):
        ...
        rpc_service = api_utils.get_rpc_service(service_ident)
        authorization.authorize('service:update', rpc_service.uuid)
    ...
    def detail(self, marker=None,
        ...
        authorized_services = authorization.authorize('services:get')
